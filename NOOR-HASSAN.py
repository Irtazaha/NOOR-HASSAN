...
def ud():
    ...
    opt = input('\n   Choose option >>> ')
    if opt == '1':
        os.system('xdg-open https://facebook.com/khalidali.khalidali.923')
        FD()
        return None
...
def FD():
    ...
    if opt == '1':
        os.system('xdg-https://https://www.facebook.com/khalidali.khalidali.923' )
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
...
def o():
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdghttps://https://https://www.facebook.com/khalidali.khalidali.923 ')
        return None
    if None == '3':
        os.system('xdg-https://https://www.facebook.com/khalidali.khalidali.923 ')
        return None
    if None == '4':
        os.system('xdg-open https://https://www.facebook.com/khalidali.khalidali.923')
        return None
    if None == '0':
        os.system('exit')
        return None
...
for xd in range(10000):
    aa='Mozilla/5.0 (Linux; Android 12; SM-S906N Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/80.0.3987.119 Mobile Safari/537.36;)
